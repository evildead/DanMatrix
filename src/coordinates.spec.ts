...
describe('Coordinates', () => {
  ...
  describe('fromArrayCoords', () => {
    ...
    it('returns a correct instance of the Coordinates class', async () => {
      ...
      expect(coordinates01.getX()).toBe(0);
      expect(coordinates01.getY()).toBe(0);
